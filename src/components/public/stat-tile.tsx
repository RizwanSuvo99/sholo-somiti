...
const TONES: Record<Tone, { shell: string; badge: string; value: string; label: string }> = {
  emerald: {
    shell: 'border-emerald-200/70 bg-gradient-to-br from-emerald-50 to-teal-100/70',
    badge: 'bg-emerald-600 text-white shadow-emerald-600/25',
    value: 'text-emerald-900',
    label: 'text-emerald-800/80',
  },
  sky: {
    shell: 'border-sky-200/70 bg-gradient-to-br from-sky-50 to-cyan-100/70',
    badge: 'bg-sky-600 text-white shadow-sky-600/25',
    value: 'text-sky-900',
    label: 'text-sky-800/80',
  },
  amber: {
    shell: 'border-amber-200/70 bg-gradient-to-br from-amber-50 to-orange-100/70',
  ...
  rose: {
    shell: 'border-rose-200/70 bg-gradient-to-br from-rose-50 to-pink-100/70',
    badge: 'bg-rose-600 text-white shadow-rose-600/25',
    value: 'text-rose-900',
    label: 'text-rose-800/80',
  },
  indigo: {
    shell: 'border-indigo-200/70 bg-gradient-to-br from-indigo-50 to-blue-100/70',
...
export function StatTile({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -top-10 -right-10 h-28 w-28 rounded-full bg-white/40 blur-2xl" />
